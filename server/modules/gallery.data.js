const galleryItems = [
    { id: 1, path: './images/LilPK.png', description: 'Lil P, circa Iran 1993', likes: 0 },
    { id: 2, path: './images/PP1.png', description: 'Penelope is the first cat I adopted on my own. The moment we locked eyes I knew we were for each other. She loves cuddling, playing fetch, and headbutting things.', likes: 0 },
